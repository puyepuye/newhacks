...
openai.api_key = "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"
...
def classify_image():
    try:
        ...
        image_description = 'imagine it work'
        image_color = 'blue'
...
def generate_question(clothes, temp, wind, precipitation):
    ...
    questions = questions + ". Today's tempurature is " + str(temp) + " degrees celsius, the wind is " + str(wind) + ", the precipitations is " + str(precipitation) + "percent. Please choose 5 clothing items for me to wear."
...
if __name__ == '__main__':
    ...
    print(generate_question([Clothing("Blue", "ack"), Clothing("Black", "rack"), Clothing("black", 'dress pants'), Clothing("grey", "hoodie"), Clothing("white", "hat"), Clothing("yellow", "raincoats")], 28, 3, 50))
